...
export function PaymentInfoPage() {
  const { methods, isLoading } = usePaymentInfoLogic();
          ...
          <CardContent>
            <div className="space-y-3 text-sm text-orange-700">
              <div className="flex gap-2">
                ...
                <p>
                  <strong>Confirmación de pago:</strong> Confirma siempre tu
                  pago por WhatsApp para acelerar la activación de créditos.
                </p>
              </div>
              <div className="flex gap-2">
                <AlertCircle className="size-4 shrink-0 mt-0.5" />
              ...
              <div className="flex gap-2">
                ...
                <p>
                  ...
                  recomienda usarlos de forma regular para mantener la
                  progresión.
                </p>
              </div>
              <div className="flex gap-2">
