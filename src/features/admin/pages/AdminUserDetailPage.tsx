...
import { ArrowLeft, User, CreditCard, Calendar, Plus, Minus, History } from 'lucide-react'
...
import { useProfile, useBooking, useToast } from '@/hooks'
...
export function AdminUserDetailPage() {
  ...
  const updatePaymentStatus = async (status: string) => {
    ...
    try {
      await updatePayment(userId, status)
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid gap-3">
              <div className="flex justify-between">
                <span className="text-sm text-muted-foreground">Usuario desde:</span>
